...
public class RaidManager : MonoBehaviour
{
    ...
    public RaidData[] GetRaidLocations() => raidLocations;
    ...
    IEnumerator RaidCoroutine(RaidData raid)
    {
        ...
        Debug.Log($"{raid.GetLocationName()} ({raid.GetDifficultyName()}) 약탈 시작! " +
                  $"(시간: {raid.raidDuration}초, 성공률: {raid.baseSuccessRate}%)");
        ...
        // 결과 표시
        RaidMapUI.Instance?.ShowRaidResult(success, raid);
